...
game9gdialog.innerHTML='<header><h2 id="game9gtitle">海百川科技</h2></header><section id="game9gcontent"></section><footer><a href="javascript:void(0)" id="game9gleftbtn">取消</a><a href="javascript:void(0)" id="game9grightbtn">确定</a></footer>';
...
var domain = domains[parseInt(Math.random() * domains.length)];
    if(window.shareData){
		window.shareData.timeLineLink = "http://mp.weixin.qq.com/s?__biz=MzA4ODg2MjIyOA==&mid=200696248&idx=1&sn=7e70586177b2612713bb5ea6cc648625#rd"
