...
function(bt) {
	bt.URL = {
		...
		getMoreGame: function() {
			bt.dc("more");
			return "http://www.17w67.com/index.html?from=daoguo"
		},
		getConcern: function() {
			return aboutus;
		},
...
function(bt) {
	...
	var loading = function(d, e) {
			if (d > 0x0 && !b) {
				...
				b.html('<table><tr><td><img class="bt-img" src="sources/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
function(bt) {
	function ask(b) {
		if (confirm('关注"欢乐小游戏"微信，就可以收藏这个游戏哦！')) {
...
function(bt) {
	...
	function tip() {
		var c = bt.advertisement({
			id: b,
			html: "<img class='bt-play-share-tip-img' src='sources/bt-play-share-tip.png' />",
			time: 0x0
		});
		c.show();
		setTimeout(function() {
...
function(bt) {
	...
	var c = {
		width: "66",
		src: "http://mmbiz.qpic.cn/mmbiz/kG4NuD28mGicMhMQYhhsZqcmsRxo0Xw6BeZs75yHUfFF24uyv4y9cKgExt20ps1Rw43s2cmTjAjNLoAtdUmhb8g/640",
		url: "http://115.28.233.243/lightapp/answerquestion/index.htm",
